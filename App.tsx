...
function App() {
  ...
  return (
    <div className="min-h-screen font-sans text-neo-black overflow-x-hidden selection:bg-neo-pink selection:text-neo-black">
      ...
      <main className="w-full">
        ...
        {currentView === ViewState.ARTICLES && (
          <ListView 
            type={ViewState.ARTICLES} 
            setView={setView}
            setSelectedArticle={setSelectedArticle}
          />
        )}
        {currentView === ViewState.ARTICLE_DETAIL && selectedArticle && (
          <ArticleDetailView 
      ...
      {/* Show global footer only on non-home pages */}
      {currentView !== ViewState.HOME && currentView !== ViewState.ARTICLE_DETAIL && (
